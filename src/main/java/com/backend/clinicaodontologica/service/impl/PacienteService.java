...
import com.backend.clinicaodontologica.repository.impl.PacienteRepository;
...
public class PacienteService implements IPacienteService {
    ...
    public PacienteSalidaDto registrarPaciente(PacienteEntradaDto paciente) {
        ...
        Paciente pacienteEntidaConId = pacienteRepository.registrar(pacienteEntidad);
    ...
    public List<PacienteSalidaDto> listarPacientes() {
        ...
        List<PacienteSalidaDto> pacientesSalidaDto = pacienteRepository.listarTodos()
                .stream()
    ...
    public PacienteSalidaDto modificarPaciente(PacienteEntradaDto pacienteEntradaDto, Long id) throws ResourceNotFoundException {
        ...
        Paciente pacienteAActualizar = pacienteRepository.buscarPorId(id);
        ...
        if (pacienteAActualizar != null) {
            ...
            pacienteRepository.registrar(pacienteAActualizar);
